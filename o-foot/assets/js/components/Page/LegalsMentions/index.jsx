    ...
    <Container>
      <div className="main">
        <div className="main-section">
          ...
          <p>
            ‘O’Foot SA’ – ‘Forme juridique’ au capital de 100 euros – RCS 154321654 – ‘7 rue du stade’
            ‘0745454545’ – ‘ofoot@gmail.com’
        ...
        <div className="main-section">
          ...
          <p>
            L’utilisation du présent site O’Foot implique l’acceptation pleine et entière des conditions générales d’utilisation décrites ci-après.
          ...
          <h3>Informations</h3>
          <p>
            Les informations et documents de l’application O’Foot sont présentés à titre indicatif, n’ont pas de caractère exhaustif, et ne peuvent engager la responsabilité du propriétaire du site.
